      ...
      <CardBody className="p-4 flex items-center gap-4">
        ...
        <div className="flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
          ...
          <Typography
            variant="h5"
            color="blue-gray"
            className="font-bold leading-snug text-left sm:text-right text-base sm:text-xl"
          >
            {value}
          </Typography>
        </div>
...
export function Home() {
  ...
  // Recent activities state (same as staff dashboard)
  ...
  // Load recent activities (copy of staff dashboard logic)
        ...
        <>
          ...
          <div className="mb-12 grid grid-cols-1 gap-6 xl:grid-cols-2">
            ...
            <Card className="mt-6 xl:mt-0">
              ...
              <CardBody className="px-6 pt-0 flex flex-col gap-3">
                <Button color="green" className="flex w-full items-center justify-center gap-3 sm:justify-start" onClick={() => navigate("/dashboard/ownership")}> <ClipboardDocumentListIcon className="h-5 w-5" /> Ownership Management </Button>
                ...
                <Button color="purple" className="flex w-full items-center justify-center gap-3 sm:justify-start" onClick={() => navigate("/dashboard/payments")}> <CurrencyDollarIcon className="h-5 w-5" /> Payment Monitoring </Button>
                <Button color="amber" className="flex w-full items-center justify-center gap-3 sm:justify-start" onClick={() => navigate("/dashboard/activity-log")}> <DocumentTextIcon className="h-5 w-5" /> Activity Log </Button>
              </CardBody>
            </Card>
          </div>
          {/* Recent Activity */}
